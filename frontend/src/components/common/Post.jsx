...
const Post = ({ post }) => {
    ...
    const { mutate: commentPost, isPending: isCommenting } = useMutation({
        ...
        onSuccess: (updatedPost) => {
            ...
            // instead, update the cache directly for that updatedPost
                    ...
                    <div className='flex justify-between mt-3'>
                        <div className='flex gap-4 items-center w-2/3 justify-between'>
                            ...
                            <div className='flex gap-1 items-center group cursor-pointer' onClick={handleLikePost}>
                                ...
                                {isLiked && !isLiking && <FaRegHeart className='w-4 h-4 cursor-pointer text-pink-500 group-hover:text-pink-500 ' />}

                                <span
                                    className={`text-sm group-hover:text-pink-500 ${isLiked ? "text-pink-400" : "text-slate-500"
                                        }`}
                                >
                                    {post.likes.length}
                                </span>
